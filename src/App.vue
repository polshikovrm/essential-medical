    ...
    <div id="app">
                ...
                <!--<div class="form-catalog-type">-->
                    ...
                    <!--<div class="field-row">-->
                        ...
                        <!--<div class="input-box">-->
                            ...
                            <!--</select>-->
                            <!--&lt;!&ndash;<span class="form-group__message" v-if="!$v.model.parent.required">Name is required.</span>&ndash;&gt;-->
                        <!--</div>-->
                    <!--</div>-->
                    <!--<div class="field-row">-->
        ...
        <!--<div class="block">-->
            <!--<div class="col3">-->
                ...
                <!--<div class="form-catalog-type">-->
                    <!--<div class="field-row">-->
                        <!--<span class="form-group__message" v-if="$v.modelCatalog.$invalid">Form is not Valid</span>-->
                    <!--</div>-->
                    <!--<div class="field-row">-->
                        <!--<label for="c_id">Id:</label>-->
                        <!--<input id="c_id" type="text" v-bind:value="modelCatalog.id"><i>Hidden</i>-->
                    <!--</div>-->
                    <!--<div class="field-row">-->
                        <!--<label for="c_title">Title:</label>-->
                        <!--<div class="input-box">-->
                            <!--<input id="c_title" type="text" v-model="modelCatalog.title">-->
                            <!--<span class="form-group__message" v-if="!$v.modelCatalog.title.required">Name is required.</span>-->
                            <!--<span class="form-group__message" v-if="!$v.modelCatalog.title.minLength">Name must have at least {{ $v.modelCatalog.title.$params.minLength.min }} letters.</span>-->
                        <!--</div>-->
                    <!--</div>-->
                    <!--<div class="field-row">-->
                        <!--<label for="c_description">Description:</label>-->
                        <!--<div class="input-box">-->
                            <!--<input id="c_description" type="text" v-model="modelCatalog.description">-->
                            <!--<span class="form-group__message" v-if="!$v.modelCatalog.description.minLength">Name must have at least {{ $v.modelCatalog.description.$params.minLength.min }} letters.</span>-->
                        <!--</div>-->
                    <!--</div>-->
                    <!--<div class="field-row">-->
                        ...
                        <!--<div class="input-box">-->
                            ...
                            <!--</select>-->
                            <!--<span class="form-group__message" v-if="!$v.modelCatalog.type.required">Name is required.</span>-->
                        <!--</div>-->
                    <!--</div>-->
                    <!--<div class="field-row">-->
                        <!--<label for="c_active">Active:</label>-->
                        <!--<div class="input-box">-->
                            <!--<input type="checkbox" id="c_active" v-model="modelCatalog.active">-->
                            <!--<span class="form-group__message" v-if="!$v.modelCatalog.active.required">Name is required.</span>-->
                        <!--</div>-->
                    <!--</div>-->
                    <!--<div class="field-row">-->
                        <!--<label for="c_order">Order:</label>-->
                        <!--<div class="input-box">-->
                            <!--<input type="number" id="c_order" v-model="modelCatalog.order">-->
                            <!--<span class="form-group__message" v-if="!$v.modelCatalog.order.required">Name is required.</span>-->
                        <!--</div>-->
                    <!--</div>-->
                    <!--<button v-if="modelCatalog.id === ''" @click.prevent="createCatalog">Create Catalog</button>-->
                    <!--<button v-if="modelCatalog.id !== ''" @click.prevent="updateCatalog">Update Catalog</button>-->
                    <!--<button @click.prevent="resetFormCatalog">Reset</button>-->


                    <!--<div class="field-row">-->
                        <!--&lt;!&ndash;<label for="c_parent">Sublevels:</label>&ndash;&gt;-->
                        <!--&lt;!&ndash;<div class="input-box">&ndash;&gt;-->
                            <!--&lt;!&ndash;<button @click.prevent="addCatalogSublevel">Add Sublevel</button>&ndash;&gt;-->
...
<script>
    ...
    export default {
        ...
        validations: {
            ...
            modelCatalog: Catalog.validations.model,
        },
        firebase: {
            fb_catalogType: {
